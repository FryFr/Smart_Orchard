      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            fit: BoxFit.cover,
            image: Image.asset(
              'assets/images/f5d8c9b8-5729-48c1-b1dc-b298c11a17c6.jpg',
            ).image,
          ),
        ),
        child: Padding(
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          'La tecnologia de los huertos al alcance de tu mano',
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: FlutterFlowTheme.of(context).bodySmall,
                            hintText:
                                'Ingrese la misma contraseña de arriba...',
                            hintStyle: FlutterFlowTheme.of(context).bodySmall,
                            enabledBorder: OutlineInputBorder(
                              borderSide: BorderSide(
                                color: FlutterFlowTheme.of(context).alternate,
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              AutoSizeText(
                                'Usa una de estas opciones para ingresar',
