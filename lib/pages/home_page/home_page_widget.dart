                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Image.asset(
                              'assets/images/vecteezy_green-plant-in-pot-3d-rendering-isolated-on-white_19862597_264.png',
                              fit: BoxFit.fitHeight,
                            ),
                          ),
                        ],
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Panel sucio, limpiar el panel solar',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Outfit',
                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    8.0, 4.0, 8.0, 0.0),
                                child: Text(
                                  'Presiona aquí para obtener información de tus sensores',
                                  textAlign: TextAlign.center,
                                  style: GoogleFonts.getFont(
                                    'Lexend Deca',
                                    color: Color(0xB3FFFFFF),
